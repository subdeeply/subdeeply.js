import { Content, IpfsCid as RuntimeIpfsCid } from '@subdeeply/definitions/interfaces';
import { IpfsCommonContent, IpfsCommentContent, IpfsCid, ImportCandidate } from '../types/ipfs';
import { newLogger, pluralize, isEmptyArray } from '@subdeeply/utils';
import axios, {  } from 'axios';
import { getUniqueIds, isIpfs, asIpfsCid } from '../utils/common';
import { SubdeeplyContext, ContentResult, UseServerProps, CommonContent } from '../types';
...
export type SubdeeplyIpfsProps = SubdeeplyContext & {
  ipfsNodeUrl: IpfsUrl,
...
const log = newLogger(SubdeeplyIpfsApi.name);
